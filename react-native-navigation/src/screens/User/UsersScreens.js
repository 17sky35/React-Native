...
export const UserListScreen = ({navigation}) => {
    ...
    return(
        <ScrollView style={{flex:12,padding:20}}>
            ...
            {users.map((user) => (
                ...
                >
                    ...
                    <Pressable
                        onPress={()=>navigation.navigate("UserProfile",{name:user.name,email:user.email})}
                        style={{
...
export const UserProfileScreen = ({route}) => {
    ...
    return(
        <View style={{flex:1,padding:20}}>
            ...
            <Text style={{fontSize:24,marginTop:10}}>{email}</Text>
        </View>
    )
}